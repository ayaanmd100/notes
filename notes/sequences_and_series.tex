...
\text{Sum of even integers } 2 + 4 + \cdot\cdot\cdot + 2n\text{: } S = n(n + 1)

\text{Sum of even integers } 2 + 4 + 6 + \cdot\cdot\cdot + 450\text{:}
n = 225, \quad S = \frac{225}{2}(2 + 450) = \frac{225 \cdot 452}{2} = 50850

\text{Telescoping d\text{ iff }erences of squares:}
