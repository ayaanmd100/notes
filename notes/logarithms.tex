\text{Definition: } \log_b(x) = n \text{ iff } b^n = x
...
\text{Remainder of } k \div 6\text{: use } 10^{20} \text{ mod } 6
10 \equiv 4 \text{ (\text{ mod } } 6 \text{)},\; 10^2 \equiv 4 \text{ (\text{ mod } } 6 \text{)},\; \text{so } 10^{20} \equiv 4 \text{ (\text{ mod } } 6 \text{)}
...
\text{Equal bases: set exponents equal.}
\text{Otherwise: take log of both sides and apply the power rule.}

\text{Chain rule of logs:}
