\text{Factorial: } n! = n \cdot (n-1) \cdot (n-2) \cdot\cdot\cdot 2 \cdot 1, \quad 0! = 1
...
\text{Passcode: 7 characters \{X,Y,3,2,Q,7,B\}; starts with letter,}
\text{ends with number, no repeats.}
\text{Letters: X,Y,Q --- pick 1 for first: 3 choices}
\text{Numbers: 3,2,7 --- pick 1 for last: 3 choices}
\text{Middle 5 positions: arrange remaining 5: } 5! = 120
